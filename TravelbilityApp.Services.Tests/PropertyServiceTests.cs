...
namespace TravelbilityApp.Services.Tests
{
    ...
    public class PropertyServiceTests
    {
        ...
        [Test]
        public async Task DeleteByIdAsync_ShouldSetStatusToDeleted_WhenPropertyExists()
        {
            // Arrange
            var propertyId = Guid.NewGuid();

            var mockedPproperty = new Property { Id = propertyId, Status = PropertyStatus.Published };

            mockedRepository
                .Setup(r => r.GetByIdAsync<Property>(propertyId))
                .ReturnsAsync(mockedPproperty);
            ...
            // Act
            await propertyService.DeleteByIdAsync(propertyId);

            // Assert
            Assert.That(mockedPproperty.Status, Is.EqualTo(PropertyStatus.Deleted));
            mockedRepository.Verify(r => r.SaveChangesAsync(), Times.Once);
        }

        [Test]
        public async Task DeleteByIdAsync_ShouldNotCallSave_WhenPropertyDoesNotExist()
        {
            // Arrange
            var propertyId = Guid.NewGuid();
        ...
        [Test]
        public async Task DeleteByIdAsync_ShouldNotCallSave_WhenPropertyIsAlreadyDeleted()
        {
            // Arrange
            var propertyId = Guid.NewGuid();

            var mockedProperty = new Property { Id = propertyId, Status = PropertyStatus.Deleted };

            mockedRepository
                .Setup(r => r.GetByIdAsync<Property>(propertyId))
                .ReturnsAsync(mockedProperty);
            ...
            // Assert
            mockedRepository.Verify(r => r.SaveChangesAsync(), Times.Never);
            Assert.That(mockedProperty.Status, Is.EqualTo(PropertyStatus.Deleted));
        }

        [Test]
        public async Task PublishByIdAsync_ShouldSetStatusToPublished_WhenPropertyExistsAndIsNotPublished()
        {
            // Arrange
            var propertyId = Guid.NewGuid();

            var mockedPproperty = new Property { Id = propertyId, Status = PropertyStatus.Saved };
            ...
            // Act
            await propertyService.PublishByIdAsync(propertyId);

            // Assert
            Assert.That(mockedPproperty.Status, Is.EqualTo(PropertyStatus.Published));
            mockedRepository.Verify(r => r.SaveChangesAsync(), Times.Once);
        }

        [Test]
        public async Task PublishByIdAsync_ShouldNotCallSave_WhenPropertyDoesNotExist()
        {
            // Arrange
            var propertyId = Guid.NewGuid();
        ...
        [Test]
        public async Task PublishByIdAsync_ShouldNotCallSave_WhenPropertyIsAlreadyPublished()
        {
            // Arrange
            var propertyId = Guid.NewGuid();

            var mockedProperty = new Property { Id = propertyId, Status = PropertyStatus.Published };
            ...
            // Assert
            mockedRepository.Verify(r => r.SaveChangesAsync(), Times.Never);
            Assert.That(mockedProperty.Status, Is.EqualTo(PropertyStatus.Published));
        }

        [Test]
        public async Task SaveByIdAsync_ShouldSetStatusToSaved_WhenPropertyExistsAndIsNotSaved()
        {
            // Arrange
            var propertyId = Guid.NewGuid();
            ...
            // Assert
            Assert.That(mockedProperty.Status, Is.EqualTo(PropertyStatus.Saved));
            mockedRepository.Verify(r => r.SaveChangesAsync(), Times.Once);
        }

        [Test]
        public async Task SaveByIdAsync_ShouldNotCallSave_WhenPropertyDoesNotExist()
        {
            // Arrange
            var propertyId = Guid.NewGuid();
        ...
        [Test]
        public async Task SaveByIdAsync_ShouldNotCallSave_WhenPropertyIsAlreadySaved()
        {
            // Arrange
            var propertyId = Guid.NewGuid();

            var mockedProperty = new Property { Id = propertyId, Status = PropertyStatus.Saved };
